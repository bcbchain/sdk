...
// OrgName get token's organization's name
func (t *Token) OrgName() string { return t.tk.OrgName }

// Proto get token's proto
func (t *Token) Proto() string { return t.tk.Proto }
