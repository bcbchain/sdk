...
func InitKMS(keyStoreDir, sigMode, sigUrl, caPath string, coinType string) {
...
// passphrase	用来保护账户的口令（
// data			待签名数据
func SignData(name, passphrase string, data []byte) (*Ed25519Sig, error) {
...
func LocalSignData(name, passphrase string, data []byte) (*Ed25519Sig, error) {
...
func HttpsSignData(enPrivKey, passphrase string, data []byte) (*Ed25519Sig, error) {
